...
$Referer_check_domain = "https://shunta-dayo.com";
...
$require = array('お名前','メールアドレス（半角）','お問い合わせ内容');
...
<!-- ▼************ 送信内容表示部　※編集は自己責任で ************ ▼-->
<div id="formWrap" class="wrapper">
	<div class="container">
		<?php if($empty_flag == 1){ ?>
			<div align="center">
				<p class="title-text">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</p>
		<?php echo $errm; ?><br /><br /><input class="button" type="button" value=" 前画面に戻る " onClick="history.back()">
			</div>
		<?php }else{ ?>
			<h2 align="center">確認画面</h2>
			<p class="title-text" align="center">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><p class="title-text">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</p><div style="color:red"><?php echo $errm; ?></div><br /><br /><input class="button" type="button" value=" 前画面に戻る " onClick="history.back()"></div>
<?php 
